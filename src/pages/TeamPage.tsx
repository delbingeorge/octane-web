    ...
    return (
        <div className="lg:my-24 flex items-center justify-center flex-col bg-profile-x-bg-cover">
            <div className="flex items-center justify-center flex-col lg:my-12">
                <h4 className="text-xl text-white font-inter">
                    Meet team{" "}
                ...
                <h1 className="text-white text-4xl font-semibold lg:my-1 font-inter">We build this together!</h1>
            </div>
            <div className="grid grid-cols-2 gap-8 lg:w-5/6">
                {teamOctane.map((value, key) => {
                    return (
                        <div
                            key={key}
                            className="flex items-start justify-start group space-x-8 p-4 duration-500 hover:cursor-pointer hover:bg-white/5 rounded-xl"
                        >
                            <img
                            ...
                            />
                            <div className="">
                                <h1 className="font-mono text-white text-[1.7rem] font-extrabold">
